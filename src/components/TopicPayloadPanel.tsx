...
export function TopicPayloadPanel({ topicNode }: { topicNode: TopicNode }) {
  ...
  return (
    <div className="flex-1 min-h-0 flex flex-col overflow-hidden">
      {/* Metadata — retained flag, QoS, and MQTT v5 properties. Above the payload.
      ...
      {/* Payload — full content, scrollable. Divider only when metadata sits above. */}
      {topicNode.lastPayload !== null ? (
        <div className="p-3 min-h-0 flex-1 flex flex-col border-t border-gray-700/50">
